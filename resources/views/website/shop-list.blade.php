@include('website.nav')
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="grid-list-product-wrapper">
                            <div class="product-list product-view pb-20">
                                <div class="row">
                                    <div
                                        class="product-width col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb @if ($product->sale!=null)
 ...
 @endif
                                    ...
                                    <div
                                        class="product-width pro-list-none col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb @if ($product->sale!=null)
