        ...
        <div class="row blog-grid">
                ...
                <div class="single-blog-wrapper mb-40">
                    <div class="blog-img mb-30">
                        <a href="blog-details-standerd.php">
                            <img src={{ url('website/assets/img/blog/blog-masonry-1.jpg') }} alt="" />
                        </a>
                    </div>
                    ...
                    <p>
                        ...
                        adipisicin sed do eiusmod tempor incididunt ut
                        labore dolore mag aliqua. Ut enim ad minim
                        veniam
                    </p>
                        ...
                        <div class="quote-content">
                            ...
                            <h3>
                                <a href="blog-details-quote.php">Lorem ipsum dolor sit amet co
                                    ...
                                    tempor incididunt is labore et
            ...
            <div class="col-lg-4 col-md-6 blog-grid-item">
                <div class="single-blog-wrapper mb-40">
                    <div class="blog-img mb-30">
                        <a href="blog-details-standerd.php">
                            <img src={{ url('website/assets/img/blog/blog-masonry-2.jpg') }} alt="" />
                        </a>
                    </div>
                    <div class="blog-content">
                        <h2>
                            <a href="blog-details-standerd.php">Que Herbal Matcha Tea</a>
                        </h2>
                        <div class="blog-date-categori">
                            <ul>
                                <li>October 14, 2018</li>
            ...
            <div class="col-lg-4 col-md-6 blog-grid-item">
                <div class="single-blog-wrapper mb-45">
                    <div class="blog-img mb-30">
                        <a href="blog-details-standerd.php">
                            <img src={{ url('website/assets/img/blog/blog-masonry-3.jpg') }} alt="" />
                        </a>
                    </div>
                    <div class="blog-content">
                        <h2>
                            <a href="blog-details-standerd.php">Green Tea Tulsi Time</a>
                        </h2>
                        <div class="blog-date-categori">
                            <ul>
                                <li>October 14, 2018</li>
            ...
            <div class="col-lg-4 col-md-6 blog-grid-item">
                <div class="single-blog-wrapper mb-40">
                    ...
                    <div class="blog-content">
                        <h2>
                            <a href="blog-details-video.php">Nature Close Tea</a>
                        </h2>
                        <div class="blog-date-categori">
                            <ul>
                                <li>October 14, 2018</li>
