                        ...
                        <div class="main-menu">
                            <nav>
                                <ul>
                                    ...
                                    <li class="top-hover">
                                       <a href={{route('blog-left-sidebar')}}>blog</a>
                                        <ul class="submenu">
                                            <li>
                                            ...
                                            <li>
                                               <a href="">Blog Standard
                                                    <span><i class="ion-ios-arrow-right"></i></span></a>
                                                <ul class="lavel-menu">
                                                    <li>
                                                       <a href={{route('blog-left-sidebar')}}>left
                                                            sidebar</a>
                                                    </li>
                                                    <li>
                                                       <a href={{route('blog-right-sidebar')}}>right
                                                            sidebar</a>
                                                    </li>
                                                    <li>
                                                       <a href={{route('blog-no-sidebar')}}>no
                                                            sidebar</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li>
                                               <a href=''>Post Types
                                                ...
                                                <ul class="lavel-menu">
                                                    ...
                                                    <li>
                                                       <a href={{route('blog-details-audio')}}>audio
                                                            post</a>
                                                    </li>
                                                    <li>
                                                       <a href={{route('blog-details-video')}}>video
                                                            post</a>
                                                    </li>
                                                    <li>
                                                       <a href={{route('blog-details-gallery')}}>gallery
                                                            post</a>
                                                    </li>
                                                    <li>
                                                       <a href={{route('blog-details-link')}}>link
                                                            post</a>
                                                    </li>
                                                    <li>
                                                       <a href={{route('blog-details-quote')}}>quote
                                                            post</a>
                                                    </li>
                                                </ul>
                                            </li>
                                ...
                                <ul>
                                    <li class="single-shopping-cart">
                                        <div class="shopping-cart-img">
                                           <a href=""><img alt="" src={{url('website/assets/img/cart/cart-1.jpg')}} /></a>
                                        </div>
                                    ...
                                    <li class="single-shopping-cart">
                                        <div class="shopping-cart-img">
                                           <a href=""><img alt="" src={{url('website/assets/img/cart/cart-2.jpg')}} /></a>
                                        </div>
                                        <div class="shopping-cart-title">
                                            <h4>
