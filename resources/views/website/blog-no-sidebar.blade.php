    ...
    <div class="container">
        <div class="single-blog-wrapper mb-40">
            ...
            <div class="blog-content">
                <h2>
                    <a href="blog-details-standerd.php">Que Herbal Daily Tea
                    </a>
                </h2>
        ...
        <div class="single-blog-wrapper mb-40">
            ...
            <div class="blog-content">
                <h2>
                    <a href="blog-details-audio.php">Instant Green Tea Premix</a>
                </h2>
                <div class="blog-date-categori">
                    <ul>
                        <li>October 14, 2018</li>
            ...
            <blockquote>
                <div class="quote-post">
                    <div class="quote-content">
                        ...
                        <h3>
                            <a href="blog-details-quote.php">Lorem ipsum dolor sit amet, consecte
                                adipicing elit, sed do eiusmod tempor
                                incididunt ut labore et dolore magna
                                aliqua. Ut enim ad minim veniam,</a>
                        </h3>
                        <h6>Tasnim</h6>
                    </div>
                    <div class="post-img">
        ...
        <div class="single-blog-wrapper mb-40">
            ...
            <div class="blog-content">
                <h2>
                    <a href="blog-details-gallery.php">Que Herbal Matcha Tea</a>
                </h2>
                <div class="blog-date-categori">
                    <ul>
                        <li>October 14, 2018</li>
        ...
        <div class="single-blog-wrapper">
            <div class="link-post">
                <div class="link-content">
                    <span>October 14, 2018 </span>
                    <h3>
                        <a href="blog-details-link.php">Lorem ipsum dolor sit amet co adipisicing
                            elit,</a>
                    </h3>
                </div>
                <div class="post-img">
