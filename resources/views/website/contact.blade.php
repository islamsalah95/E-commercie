                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="small-title mb-30">
                            ...
                            <p>
                                ...
                                Ipsum available, but the majority Lorem Ipsum
                                available.
                            </p>
                        </div>
                        <form
                            id="contact-form"
                            action="https://d29u17ylf1ylz9.cloudfront.net/sabujcha/assets/mail.php"
                            method="post"
                        >
                            <div class="row">
                                <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div
                                    class="contact-information contact-mrg mb-30"
                                >
                                    <h4>Phone Number</h4>
                                    <p>
        ...
        <script>
            function init() {
                ...
                var marker = new google.maps.Marker({
                    ...
                    map: map,
                    icon: {{url('website/assets/img/icon-img/map.png')}},
