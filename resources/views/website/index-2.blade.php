@include('website.nav')
            ...
            <div class="slider-area">
                <div class="slider-active owl-dot-style owl-carousel">
                    <div
                        class="single-slider ptb-265 bg-img"
                        style="
                    ...
                    >
                        <div class="container">
                            <div
                                class="slider-content slider-animated-1 text-center"
                            >
                    ...
                    <div class="banner-wrap">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="single-banner img-zoom mb @if ($product->sale!=null)

                                    <span>-{{$product->sale}} </span>
                                    @endif">
                                    <a href="#">
                                        <img
                                            src={{url('website/assets/img/banner/banner-1.png')}}
                                            alt=""
                                        />
                                    </a>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-banner img-zoom mb @if ($product->sale!=null)
                                    ...
                                    <a href="#">
                                        <img
                                            src={{url('website/assets/img/banner/banner-2.png')}}
                                            alt=""
                                        />
                                    </a>
                                    <div class="banner-content">
                            ...
                            <div class="testimonial-active owl-carousel">
                                <div class="single-testimonial text-center">
                                    <div class="testimonial-img">
                                        <img
                                            alt=""
                                            src={{url('website/assets/img/icon-img/testi.png')}}
                                        />
                                    </div>
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur
                ...
                <div class="container">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active">
                            <div
                                class="featured-product-active owl-carousel product-nav"
                            >
                                <div class="product-wrapper-single">
                                    <div class="product-wrapper mb @if ($product->sale!=null)
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-4">
                            <div class="blog-single mb @if ($product->sale!=null)
                                ...
                                <div class="blog-thumb">
                                    <a href="#"
                                        ><img
                                            src={{url('website/assets/img/blog/blog-single-1.jpg')}}
                                            alt=""
                                    /></a>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="blog-single mb @if ($product->sale!=null)
                                ...
                                <div class="blog-thumb">
                                    <a href="#"
                                        ><img
                                            src={{url('website/assets/img/blog/blog-single-2.jpg')}}
                                            alt=""
                                    /></a>
                                </div>
                                <div class="blog-content pt-25">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="blog-single mb @if ($product->sale!=null)
                                ...
                                <div class="blog-thumb">
                                    <a href="#"
                                        ><img
                                            src={{url('website/assets/img/blog/blog-single-3.jpg')}}
                                            alt=""
                                    /></a>
                                </div>
                                <div class="blog-content pt-25">
                            ...
                            <div class="row">
                                <div class="col-md-5 col-sm-5 col-xs-12">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        >
                                            <img
                                                src={{url('website/assets/img/product-details/product-detalis-l1.jpg')}}
                                                alt=""
                                            />
                                        </div>
                                        <div id="pro-2" class="tab-pane fade">
                                            <img
                                                src={{url('website/assets/img/product-details/product-detalis-l2.jpg')}}
                                                alt=""
                                            />
                                        </div>
                                        <div id="pro-3" class="tab-pane fade">
                                            <img
                                                src={{url('website/assets/img/product-details/product-detalis-l3.jpg')}}
                                                alt=""
                                            />
                                        </div>
                                        <div id="pro-4" class="tab-pane fade">
                                            <img
                                                src={{url('website/assets/img/product-details/product-detalis-l4.jpg')}}
                                                alt=""
                                            />
                                        </div>
                                    </div>
