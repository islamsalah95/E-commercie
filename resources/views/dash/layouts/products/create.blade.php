...
@endif
    ...
    <div class="col-12">
        <form action="{{route('dash.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row my-3">
                <div class="col-4">
                    <input type="number" class="form-control" name="code" value="{{old('code')}}" id="" placeholder="code ">
                </div>
                <div class="col-4">
            ...
            <div class="form-row my-3">
                <div class="col-6">
                    <textarea name="desc_en" id="" cols="30" class="form-control" rows="10"
                        placeholder="Details In English">{{old('desc_en')}}</textarea>
                </div>
                <div class="col-6">
                    <textarea name="desc_ar" id="" cols="30" class="form-control" rows="10" placeholder="Details In Arabic">{{old('desc_ar')}}</textarea>
                </div>
            </div>
            <div class="form-row my-3">
                <div class="col-12">
